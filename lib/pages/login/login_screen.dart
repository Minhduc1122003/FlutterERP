...
import 'package:erp/pages/home/home_screen.dart';
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(
                                ...
                                child: TextButton(
                                    ...
                                    onPressed: () {
                                      site = _etEmail.text.split("@")[1];
                                      _loginBloc.add(Login(email: _etEmail.text.split("@")[0], password: _etPassword.text, site: site!, apiToken: apiToken));
                                      // Navigator.push(
                                      //   context,
                                      //   MaterialPageRoute(
                                      //       builder: (context) =>
