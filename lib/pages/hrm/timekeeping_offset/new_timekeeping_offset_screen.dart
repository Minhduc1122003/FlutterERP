...
class _NewTimekeepingOffsetScreenState
  ...
  Widget build(BuildContext context) {
    ...
    //     Get.put(TimekeepingOffsetController());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            InkWell(
              ...
              onTap: () {
                //controller.sendTimekeepingOffsetRequest();
                timekeepingBloc.add(SendingTimekeepingOffsetEvent());
              },
            )
          ],
        ),
        ...
        body: Padding(
          ...
          child: BlocBuilder<TimekeepingOffsetBloc, TimekeepingOffsetState>(
            ...
            return state.isSending?Center(
                  child: CircularProgressIndicator(color: mainColor)): SingleChildScrollView(
                    child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                          ...
                          return Dialog(
                            ...
                            children: [
                              ...
                              SizedBox(
                                height: 200,
                                child: CupertinoDatePicker(
                                  initialDateTime: (state.applyDate == null)
                                      ? DateTime.now()
                                      : state.applyDate,
                                  onDateTimeChanged: (value) {
                    ...
                    child: Row(
                      children: [
                        ...
                        state.shiftModel == null
                            ...
                            : Text(
                                DateFormat('HH:mm')
                                    .format(state.shiftModel!.fromTime),
                                style: const TextStyle(
                                    color: blueBlack, fontSize: 16),
                              ),
                      ],
